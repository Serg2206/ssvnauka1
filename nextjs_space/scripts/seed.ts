...
import { PrismaClient, UserRole, CourseLevel, OperationType, SurgicalMethod, Difficulty } from '@prisma/client';
...
async function main() {
  ...
  const videos = [
    // ЛАПАРОСКОПИЧЕСКИЕ ОПЕРАЦИИ (10 видео)
    {
      ...
      operationType: OperationType.CHOLECYSTECTOMY,
      method: SurgicalMethod.LAPAROSCOPIC,
      difficulty: Difficulty.BASIC,
      author: 'Проф. Иванов А.В.',
      clinic: 'НМИЦ хирургии им. А.В. Вишневского',
      durationMinutes: 45,
    ...
    },
    {
      ...
      operationType: OperationType.APPENDECTOMY,
      method: SurgicalMethod.LAPAROSCOPIC,
      difficulty: Difficulty.BASIC,
      author: 'К.м.н. Сидоров М.П.',
      clinic: 'Медицинский центр МГУ',
      durationMinutes: 32,
    ...
    },
    {
      ...
      operationType: OperationType.COLECTOMY,
      method: SurgicalMethod.LAPAROSCOPIC,
      difficulty: Difficulty.HIGH,
      author: 'Проф. Козлов В.А.',
      clinic: 'РОНЦ им. Н.Н. Блохина',
      durationMinutes: 185,
    ...
    },
    {
      ...
      method: SurgicalMethod.LAPAROSCOPIC,
      difficulty: Difficulty.HIGH,
      author: 'Д.м.н. Морозов Д.А.',
      clinic: 'НИИ колопроктологии',
      durationMinutes: 245,
    ...
    },
    {
      ...
      operationType: OperationType.HERNIA_REPAIR,
      method: SurgicalMethod.LAPAROSCOPIC,
      difficulty: Difficulty.MEDIUM,
      author: 'К.м.н. Николаев Е.В.',
      clinic: 'Клиника высоких медицинских технологий',
      durationMinutes: 55,
    ...
    },
    {
      ...
      operationType: OperationType.ESOPHAGEAL_SURGERY,
      method: SurgicalMethod.LAPAROSCOPIC,
      difficulty: Difficulty.HIGH,
      author: 'Проф. Алексеев Н.С.',
      clinic: 'ФГБУ НМИЦ хирургии',
      durationMinutes: 125,
    ...
    },
    {
      ...
      method: SurgicalMethod.LAPAROSCOPIC,
      difficulty: Difficulty.MEDIUM,
      author: 'Д.м.н. Смирнов А.Ю.',
      clinic: 'Европейская клиника',
      durationMinutes: 156,
    ...
    },
    {
      ...
      operationType: OperationType.GASTRECTOMY,
      method: SurgicalMethod.LAPAROSCOPIC,
      difficulty: Difficulty.HIGH,
      author: 'Проф. Давыдов М.И.',
    ...
    },
    {
      ...
      method: SurgicalMethod.LAPAROSCOPIC,
      difficulty: Difficulty.MEDIUM,
      author: 'К.м.н. Романов Т.С.',
      clinic: 'НИИ скорой помощи им. Склифосовского',
      durationMinutes: 95,
    ...
    // РОБОТИЗИРОВАННЫЕ ОПЕРАЦИИ (8 видео)
    {
      ...
      operationType: OperationType.GASTRECTOMY,
      method: SurgicalMethod.ROBOTIC,
      difficulty: Difficulty.HIGH,
      author: 'Проф. Кириллов Ю.Б.',
      clinic: 'НМИЦ онкологии',
      durationMinutes: 325,
    ...
    },
    {
      ...
      method: SurgicalMethod.ROBOTIC,
      difficulty: Difficulty.HIGH,
      author: 'Д.м.н. Федоров В.Д.',
      clinic: 'ГНЦ колопроктологии',
      durationMinutes: 289,
    ...
    },
    {
      ...
      operationType: OperationType.LIVER_RESECTION,
      method: SurgicalMethod.ROBOTIC,
      difficulty: Difficulty.HIGH,
      author: 'Проф. Вишневский В.А.',
      clinic: 'Институт хирургии им. Вишневского',
      durationMinutes: 385,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579165466741-7f35e4755660?w=800&q=80',
    },
    {
      ...
      operationType: OperationType.PANCREATIC_SURGERY,
      method: SurgicalMethod.ROBOTIC,
      difficulty: Difficulty.HIGH,
      author: 'Проф. Королев М.П.',
      clinic: 'РОНЦ им. Блохина',
      durationMinutes: 445,
    ...
    },
    {
      ...
      method: SurgicalMethod.ROBOTIC,
      difficulty: Difficulty.HIGH,
      author: 'Д.м.н. Черноусов А.Ф.',
      clinic: 'Первый МГМУ им. Сеченова',
      durationMinutes: 412,
      thumbnailUrl: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&q=80',
    },
    {
    ...
    },
    {
      ...
      method: SurgicalMethod.ROBOTIC,
      difficulty: Difficulty.MEDIUM,
      author: 'Д.м.н. Тимербулатов В.М.',
      clinic: 'Башкирский ГМУ',
      durationMinutes: 75,
      thumbnailUrl: 'https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=800&q=80',
    },
    {
      ...
      method: SurgicalMethod.ROBOTIC,
      difficulty: Difficulty.MEDIUM,
      author: 'К.м.н. Егоров А.В.',
      clinic: 'НМИЦ хирургии',
      durationMinutes: 148,
    ...
    // ОТКРЫТЫЕ ОПЕРАЦИИ (8 видео)
    {
      ...
      operationType: OperationType.GASTRECTOMY,
      method: SurgicalMethod.OPEN,
      difficulty: Difficulty.HIGH,
      author: 'Проф. Давыдов М.И.',
      clinic: 'МНИОИ им. Герцена',
      durationMinutes: 285,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579165466741-7f35e4755660?w=800&q=80',
    },
    {
    ...
    },
    {
      ...
      method: SurgicalMethod.OPEN,
      difficulty: Difficulty.HIGH,
      author: 'Проф. Кубышкин В.А.',
      clinic: 'МГМСУ им. Евдокимова',
      durationMinutes: 395,
      thumbnailUrl: 'https://images.unsplash.com/photo-1551076805-e1869033e561?w=800&q=80',
    },
    {
      ...
      method: SurgicalMethod.OPEN,
      difficulty: Difficulty.MEDIUM,
      author: 'Д.м.н. Прудков М.И.',
      clinic: 'Уральский ГМУ',
      durationMinutes: 78,
      thumbnailUrl: 'https://images.unsplash.com/photo-1631815589968-fdb09a223b1e?w=800&q=80',
    },
    {
    ...
    },
    {
      ...
      method: SurgicalMethod.OPEN,
      difficulty: Difficulty.HIGH,
      author: 'Д.м.н. Тимошин А.Д.',
      clinic: 'РНИМУ им. Пирогова',
      durationMinutes: 185,
      thumbnailUrl: 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=800&q=80',
    },
    {
      ...
      method: SurgicalMethod.OPEN,
      difficulty: Difficulty.MEDIUM,
      author: 'К.м.н. Жуков Б.Н.',
      clinic: 'НИИ скорой помощи',
      durationMinutes: 52,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579684453423-f84349ef60b0?w=800&q=80',
    },
    {
    ...
    // ГИБРИДНЫЕ ОПЕРАЦИИ (4 видео)
    {
      ...
      operationType: OperationType.LIVER_RESECTION,
      method: SurgicalMethod.HYBRID,
      difficulty: Difficulty.HIGH,
      author: 'Д.м.н. Ефанов М.Г.',
      clinic: 'НМИЦ хирургии',
      durationMinutes: 298,
      thumbnailUrl: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&q=80',
    },
    {
      ...
      method: SurgicalMethod.HYBRID,
      difficulty: Difficulty.HIGH,
      author: 'К.м.н. Бебуришвили А.Г.',
      clinic: 'Волгоградский ГМУ',
      durationMinutes: 254,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579165466741-7f35e4755660?w=800&q=80',
    },
    {
