...
async function main() {
  ...
  const videos = [
    ...
    // SAGES SURGICAL VIDEOS (12 видео)
    // Note: Educational videos from Society of American Gastrointestinal and Endoscopic Surgeons
    {
      title: 'Laparoscopic Repair of Incarcerated Paraesophageal Hernia Involving Gastric Pouch and Roux Limb with Mesenteroaxial Volvulus',
      description: 'Comprehensive surgical video demonstrating laparoscopic repair of a complex incarcerated paraesophageal hernia involving the gastric pouch, Roux limb, and portion of the remnant stomach with mesenteroaxial volvulus. Presented at SAGES 2019 Annual Meeting. Educational content from SAGES Video Loops.',
      videoUrl: 'https://www.sages.org/video/laparoscopic-repair-of-incarcerated-paraesophageal-hernia-involving-the-gastric-pouch-roux-limb-and-portion-of-the-remnant-stomach-with-mesenteroaxial-volvulus/',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'SAGES Faculty',
      clinic: 'SAGES - Society of American Gastrointestinal and Endoscopic Surgeons',
      durationMinutes: 12,
      thumbnailUrl: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&q=80',
    },
    {
      title: 'Laparoscopic Dormia Basket Retrieval by Choledochotomy: Case Report of Hooked Basket During ERCP',
      description: 'Innovative laparoscopic technique for retrieving a hooked Dormia basket during ERCP using choledochotomy plus primary closure with three ports. Case report demonstrating problem-solving approach in complex biliary procedures. SAGES 2019 Video Loops presentation.',
      videoUrl: 'https://www.sages.org/video/laparoscopic-dorma-basket-retrieval-by-choledochotomy-plus-primary-closure-using-three-ports-case-report-of-a-hooked-dorma-basket-during-ercp/',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'SAGES Faculty',
    ...
    {
      title: 'A Novel Laparoscopic Approach for Introduction of Magnetic Compression Anastomotic (Magnamosis) Rings',
      description: 'Groundbreaking laparoscopic technique for introducing Magnetic Compression Anastomotic (Magnamosis) Rings, demonstrating innovative approach to creating anastomosis with magnetic technology. Educational video from SAGES 2019 Annual Meeting showcasing emerging surgical techniques.',
      videoUrl: 'https://www.sages.org/video/a-novel-laparoscopic-approach-for-introduction-of-magnetic-compression-anastomotic-magnamosis-rings/',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'SAGES Faculty',
    ...
    {
      title: 'An Early Experience with eTEP Rives Stoppa Technique for Ventral Hernia Repair',
      description: 'Early clinical experience with extended Totally Extraperitoneal (eTEP) Rives Stoppa technique for ventral hernia repair. Demonstrates surgical technique, patient selection, and outcomes. Educational video from SAGES Annual Meeting highlighting advanced hernia repair methods.',
      videoUrl: 'https://www.sages.org/video/an-early-experience-with-etep-rives-stoppa/',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'SAGES Faculty',
    ...
    {
      title: 'Laparoscopic Multi-Organ Reduction and Primary Repair of a Giant Hiatal Hernia',
      description: 'Comprehensive surgical approach to giant hiatal hernia repair involving multiple organ reduction and primary repair using laparoscopic technique. Demonstrates complex anatomical considerations and surgical strategies. SAGES 2019 Video Loops presentation.',
      videoUrl: 'https://www.sages.org/video/laparoscopic-multi-organ-reduction-and-primary-repair-of-a-giant-hiatal-hernia/',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'SAGES Faculty',
    ...
    {
      title: 'Laparoscopic Repair of J-pouch Appendage Leak After Loop Ileostomy Reversal',
      description: 'Advanced laparoscopic technique for managing J-pouch appendage leak following loop ileostomy reversal. Demonstrates surgical approach to complex postoperative complications in colorectal surgery. Educational video from SAGES 2019 Annual Meeting.',
      videoUrl: 'https://www.sages.org/video/laparoscopic-repair-of-j-pouch-appendage-leak-after-loop-ileostomy-reversal/',
    ...
    {
      title: 'Large Posterior Gastro-Gastric Fistula After Gastric Bypass: Endoscopic Management',
      description: 'Endoscopic approach to managing large posterior gastro-gastric fistula following Roux-en-Y gastric bypass. Demonstrates advanced endoscopic techniques for complex bariatric complications. Educational video showcasing problem-solving strategies in bariatric surgery.',
      videoUrl: 'https://www.sages.org/video/large-posterior-gastro-gastric-fistula-after-gastric-bypass/',
      operationType: "GASTRECTOMY",
      method: "OTHER",
      difficulty: "HIGH",
      author: 'SAGES Faculty',
    ...
    {
      title: 'Laparoscopic Posterior Resection Rectopexy: Modified with Obliteration of Pouch of Douglas',
      description: 'Modified laparoscopic posterior resection rectopexy technique with obliteration of the Pouch of Douglas for treatment of rectal prolapse. Comprehensive surgical video demonstrating advanced technique by Grace S Hwang, MD and Alessio Pigazzi, MD, PhD from UC Irvine. SAGES educational content.',
      videoUrl: 'https://www.sages.org/video/laparoscopic-posterior-resection-rectopexy-modified-with-obliteration-of-pouch-of-douglas/',
      operationType: "COLECTOMY",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Grace S Hwang, MD; Alessio Pigazzi, MD, PhD',
      clinic: 'SAGES - Society of American Gastrointestinal and Endoscopic Surgeons',
      durationMinutes: 16,
      thumbnailUrl: 'https://images.unsplash.com/photo-1551190822-a9333d879b1f?w=800&q=80',
    },
    {
      title: 'Combined Bronchoscopic and Endoscopic Management of Recurrent Tracheo-Esophageal Fistula',
      description: 'Innovative combined bronchoscopic and endoscopic approach to managing recurrent tracheo-esophageal fistula. Demonstrates multidisciplinary surgical technique and advanced endoscopic skills. SAGES educational video highlighting complex airway and esophageal pathology management.',
      videoUrl: 'https://www.sages.org/video/the-combined-bronchoscopic-and-endoscopic-management-of-a-recurrent-tracheo-esophageal-fistula/',
      operationType: "OTHER",
      method: "OTHER",
      difficulty: "HIGH",
      author: 'SAGES Faculty',
    ...
    {
      title: 'Laparoscopic Repair of Bilateral Direct Inguinal Hernias with Single 30×12 cm Mesh',
      description: 'Efficient laparoscopic technique for bilateral direct inguinal hernia repair using a single 30×12 cm mesh. Demonstrates cost-effective approach and surgical efficiency in bilateral hernia management. Educational video from SAGES Annual Meeting.',
      videoUrl: 'https://www.sages.org/video/laparoscopic-repair-of-bilateral-direct-inguinal-hernias-with-on-30x12-cm-mesh/',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "MEDIUM",
      author: 'SAGES Faculty',
    ...
    {
      title: 'Laparoscopic Management of Gastric Pouch Necrosis Following Gastric Band Slippage',
      description: 'Emergency laparoscopic management of gastric pouch necrosis following adjustable gastric band slippage. Demonstrates surgical approach to life-threatening bariatric complication and decision-making process. SAGES educational video on bariatric complications management.',
      videoUrl: 'https://www.sages.org/video/laparoscopic-management-of-gastric-pouch-necrosis-following-gastric-band-slippage/',
      operationType: "GASTRECTOMY",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'SAGES Faculty',
    ...
    {
      title: 'Endoluminal Bariatric Surgery Post-Gastric Bypass: Revision Techniques',
      description: 'Advanced endoluminal revision techniques for patients post-Roux-en-Y gastric bypass. Demonstrates endoscopic suturing and other minimally invasive approaches for weight regain management. Educational video showcasing emerging endoscopic bariatric revision methods.',
      videoUrl: 'https://www.sages.org/video/endoluminal-bariatric-surgery-post-gastric-bypass/',
      operationType: "GASTRECTOMY",
      method: "OTHER",
      difficulty: "HIGH",
      author: 'SAGES Faculty',
    ...
    // MEDTUBE SURGICAL VIDEOS (12 видео)
    // Note: Free educational videos from MedTube.net - Global Medical Video Platform
    {
      title: 'Multimodal Endoscopic Treatment of Sleeve Gastrectomy Leak',
      description: 'Comprehensive surgical lecture on multimodal endoscopic treatment of sleeve gastrectomy leak presented at SAGES 5 Star Videos Session by Catherine Valukas MD, April 18, 2024. Demonstrates advanced endoscopic techniques for managing this challenging bariatric complication. Free educational content from MedTube.net.',
      videoUrl: 'https://medtube.net/bariatric-surgery/medical-videos/44237-multimodal-endoscopic-treatment-of-sleeve-gastrectomy-leak',
      operationType: "GASTRECTOMY",
      method: "OTHER",
      difficulty: "HIGH",
      author: 'Catherine Valukas, MD (SAGES)',
      clinic: 'MedTube.net - Global Medical Video Platform',
      durationMinutes: 27,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579165466741-7f35e4755660?w=800&q=80',
    },
    {
      title: 'Portless Insertion of Laparoscopic Instrument: Innovative Technique',
      description: 'Innovative technique for portless insertion of laparoscopic instrument through small skin incision without traditional port placement. Demonstrates step-by-step approach for minimally invasive surgery with reduced abdominal wall trauma. Educational video from global MedTube platform.',
      videoUrl: 'https://medtube.net/general-surgery/medical-videos/45308-portless-insertion-of-laparoscopic-instrument',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "MEDIUM",
      author: 'Mohie El-Din Mostafa Madany',
      clinic: 'MedTube.net - Global Medical Video Platform',
      durationMinutes: 5,
      thumbnailUrl: 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=800&q=80',
    },
    {
      title: 'Laparoscopic Nissen Fundoplication: Complete Surgical Technique',
      description: 'Complete laparoscopic Nissen fundoplication procedure by Shahran Nazari. Video treatment with PPIs heals esophagitis and suppresses heartburn in over 90% of patients. Despite effective maintenance therapies, patients often prefer definitive surgical treatment. Educational content from MedTube.net.',
      videoUrl: 'https://medtube.net/general-surgery/medical-videos/45342-laparoscopic-nissen-fundoplication',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Shahran Nazari, MD',
      clinic: 'MedTube.net - Global Medical Video Platform',
      durationMinutes: 22,
      thumbnailUrl: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&q=80',
    },
    {
      title: 'Methylene Blue Test After Myotomy Completion for Achalasia',
      description: 'Laparoscopic Heller cardiomyotomy is the surgical procedure of choice for management of oesophageal achalasia. It is characterized by dilatation of parameters of the myotomy and mucosal integrity verification. Demonstrates use of methylene blue test for quality control. Free medical education from MedTube platform.',
      videoUrl: 'https://medtube.net/general-surgery/medical-videos/45341-methylene-blue-test-after-myotomy-completion-for-achalasia',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Shahran Nazari, MD',
    ...
    {
      title: 'Laparoscopic Repair of Large Complex Right-Sided Diaphragmatic Hernia',
      description: 'Advanced laparoscopic technique for repairing large complex right-sided diaphragmatic hernia with comprehensive surgical approach. Demonstrates careful dissection, reduction of herniated contents, and mesh reinforcement. Educational surgical video from MedTube.net platform with global reach.',
      videoUrl: 'https://medtube.net/general-surgery/medical-videos/44430-laparoscopic-repair-of-a-large-complex-right-sided-diaphragmatic-hernia',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'MedTube Faculty',
      clinic: 'MedTube.net - Global Medical Video Platform',
      durationMinutes: 18,
      thumbnailUrl: 'https://images.unsplash.com/photo-1587854692152-cbe660dbde88?w=800&q=80',
    },
    {
      title: 'Management of Jejunal Obstruction After Roux-en-Y Gastric Bypass',
      description: 'Comprehensive approach to managing jejunal obstruction as complication after Roux-en-Y gastric bypass (RYGB). Demonstrates diagnostic workup and surgical management strategies for this bariatric complication. Free educational content from global MedTube medical video platform.',
      videoUrl: 'https://medtube.net/bariatric-surgery/medical-videos/44449-management-of-jejunal-obstruction-after-rygb',
      operationType: "GASTRECTOMY",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'MedTube Faculty',
    ...
    {
      title: 'Minimally Invasive Esophagectomy: Robotic Ivor Lewis Approach (MIE)',
      description: 'State-of-the-art minimally invasive esophagectomy using robotic Ivor Lewis approach. Demonstrates comprehensive surgical technique combining thoracoscopic and laparoscopic phases with intrathoracic anastomosis. Advanced educational content from MedTube.net global platform.',
      videoUrl: 'https://medtube.net/general-surgery/medical-videos/44309-minimally-invasive-esophagectomy-robotic-ivor-lewis-approach-mie',
      operationType: "OTHER",
      method: "ROBOTIC",
      difficulty: "HIGH",
      author: 'MedTube Faculty',
    ...
    {
      title: 'Laparoscopic Common Bile Duct Exploration with Choledochoduodenostomy for ERCP Failures',
      description: 'Advanced laparoscopic technique for common bile duct exploration with choledochoduodenostomy in cases where ERCP has failed. Demonstrates alternative surgical approach for managing choledocholithiasis. Educational video from MedTube.net - 450,000+ healthcare professionals worldwide.',
      videoUrl: 'https://medtube.net/general-surgery/medical-videos/45286-laparoscopic-common-bile-duct-exploration-with-choledochoduodenostomy-for-ercp-failures',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'MedTube Faculty',
    ...
    {
      title: 'Beating RVOT Reconstruction with Pulmonary Homograft',
      description: 'Advanced cardiac surgery technique for beating heart right ventricular outflow tract (RVOT) reconstruction using pulmonary homograft in patient undergoing fourth redo sternotomy for Truncus Arteriosus. Demonstrates meticulous planning and disciplined operative strategy to minimize ischemic time. MedTube educational content.',
      videoUrl: 'https://medtube.net/cardiac-surgery/medical-videos/45282-beating-rvot-reconstruction-with-pulmonary-homograft',
      operationType: "OTHER",
      method: "OPEN",
      difficulty: "HIGH",
      author: 'Sam Zeraatiannejad, MD',
      clinic: 'MedTube.net - Global Medical Video Platform',
      durationMinutes: 15,
      thumbnailUrl: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&q=80',
    },
    {
      title: 'MICS-AVR + Ascending Aorta Replacement: Minimally Invasive Cardiac Surgery',
      description: 'Minimally invasive cardiac surgery (MICS) technique for aortic valve replacement combined with ascending aorta replacement through right mini-thoracotomy. Demonstrates advanced approach for complex cardiac pathology with reduced surgical trauma. Free educational video from MedTube.net platform.',
      videoUrl: 'https://medtube.net/cardiac-surgery/medical-videos/44076-mics-avr-ascending-aorta-replacement',
      operationType: "OTHER",
      method: "OTHER",
      difficulty: "HIGH",
      author: 'MedTube Faculty',
    ...
    {
      title: 'CABG + LV Aneurysm Repair + Mitral Valve Repair: Complex Cardiac Surgery',
      description: 'Complex cardiac surgery combining coronary artery bypass grafting (CABG) with left ventricular aneurysm repair and mitral valve repair in single procedure. Demonstrates comprehensive approach to multivalvular and coronary disease. Educational content from global MedTube medical platform.',
      videoUrl: 'https://medtube.net/cardiac-surgery/medical-videos/44075-cabg-lv-aneurysm-repair-mv-repair',
      operationType: "OTHER",
      method: "OPEN",
      difficulty: "HIGH",
      author: 'MedTube Faculty',
    ...
    {
      title: 'Laparoscopic Management of Missed IUD: Comprehensive Approach',
      description: 'Comprehensive laparoscopic approach to managing missed intrauterine device (IUD) with exploration of tubes and ovaries bilaterally and retrieval technique using port as retrieval bag. Demonstrates systematic approach to gynecological complication. Educational video by Mohie El-Din Mostafa Madany from MedTube.net.',
      videoUrl: 'https://medtube.net/general-surgery/medical-videos/45307-when-you-do-a-laparoscopy-for-missed-iud-please-explore-the-tube-and-ovaries-on-both-sides',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "MEDIUM",
      author: 'Mohie El-Din Mostafa Madany',
    ...
    // GIBLIB SURGICAL EDUCATION VIDEOS (12 видео)
    // Note: Premium medical education platform with surgical procedure previews and conferences
    {
      title: 'Minimally Invasive Mitral Valve Repair by Tom C. Nguyen, MD, FACS, FACC',
      description: 'Surgical procedure preview demonstrating minimally invasive mitral valve repair techniques by Tom C. Nguyen, MD, FACS, FACC. Professional educational content from GIBLIB medical streaming platform. Full procedure available on watch.giblib.com with subscription.',
      videoUrl: 'https://www.youtube.com/watch?v=Aluet1KosZ4',
      operationType: "OTHER",
      method: "OTHER",
      difficulty: "HIGH",
      author: 'Tom C. Nguyen, MD, FACS, FACC',
      clinic: 'GIBLIB - Premium Medical Education Platform',
      durationMinutes: 1,
      thumbnailUrl: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&q=80',
    },
    {
      title: 'Laparoscopic Abdominal Cholecystectomy by Jonathan Carter, MD',
      description: 'Surgical procedure preview of laparoscopic abdominal cholecystectomy performed by Jonathan Carter, MD. Educational preview from GIBLIB medical streaming service. Complete procedure available on watch.giblib.com for healthcare professionals.',
      videoUrl: 'https://www.youtube.com/watch?v=gYi2MywfJYA',
      operationType: "CHOLECYSTECTOMY",
      method: "LAPAROSCOPIC",
      difficulty: "MEDIUM",
      author: 'Jonathan Carter, MD',
      clinic: 'GIBLIB - Premium Medical Education Platform',
      durationMinutes: 1,
      thumbnailUrl: 'https://images.unsplash.com/photo-1631815589968-fdb09a223b1e?w=800&q=80',
    },
    {
      title: 'Functional Total Laryngectomy by Kathryn M. Van Abel, MD',
      description: 'Surgical technique preview for functional total laryngectomy by Kathryn M. Van Abel, MD. Professional medical education content from GIBLIB streaming platform. Full surgical video available with GIBLIB subscription at watch.giblib.com.',
      videoUrl: 'https://www.youtube.com/watch?v=inEdXqK65HY',
      operationType: "OTHER",
      method: "OPEN",
      difficulty: "HIGH",
      author: 'Kathryn M. Van Abel, MD',
      clinic: 'GIBLIB - Premium Medical Education Platform',
      durationMinutes: 1,
      thumbnailUrl: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=800&q=80',
    },
    {
      title: 'Endoscopic Maxillary Antrostomy for Fungus Ball by Erin K. O\'Brien, MD',
      description: 'Endoscopic sinus surgery preview demonstrating maxillary antrostomy for fungus ball treatment by Erin K. O\'Brien, MD. Educational surgical preview from GIBLIB medical platform. Complete procedure accessible on watch.giblib.com with subscription.',
      videoUrl: 'https://www.youtube.com/watch?v=3Z1GsKD8TA8',
      operationType: "OTHER",
      method: "ENDOSCOPIC",
      difficulty: "MEDIUM",
      author: 'Erin K. O\'Brien, MD',
      clinic: 'GIBLIB - Premium Medical Education Platform',
      durationMinutes: 1,
      thumbnailUrl: 'https://images.unsplash.com/photo-1559757175-5700dde675bc?w=800&q=80',
    },
    {
      title: 'Revision Total Hip Arthroplasty with Intellijoint by Mathias P. Bostrom, MD',
      description: 'Advanced orthopedic surgery preview of revision total hip arthroplasty using Intellijoint technology by Mathias P. Bostrom, MD. Professional medical education from GIBLIB streaming service. Full surgical video available with subscription at watch.giblib.com.',
      videoUrl: 'https://www.youtube.com/watch?v=4j3-N_m_a2g',
      operationType: "OTHER",
      method: "OPEN",
      difficulty: "HIGH",
      author: 'Mathias P. Bostrom, MD',
      clinic: 'GIBLIB - Premium Medical Education Platform',
      durationMinutes: 2,
      thumbnailUrl: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&q=80',
    },
    {
      title: 'Total Wrist Arthroplasty: New Opportunities Through Kinematic Design',
      description: 'Educational conference on total wrist arthroplasty featuring new opportunities through kinematic design. Medical conference preview from GIBLIB education platform. Complete conference video available on watch.giblib.com with healthcare professional subscription.',
      videoUrl: 'https://www.youtube.com/watch?v=F_533zUMozc',
      operationType: "OTHER",
      method: "OPEN",
      difficulty: "HIGH",
      author: 'GIBLIB Medical Faculty',
      clinic: 'GIBLIB - Premium Medical Education Platform',
      durationMinutes: 7,
      thumbnailUrl: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=800&q=80',
    },
    {
      title: 'Urology Review: Comprehensive Medical Conference',
      description: 'Comprehensive urology review conference covering latest developments in urological practice. Educational medical conference from GIBLIB streaming platform. Complete conference accessible on watch.giblib.com for healthcare professionals with subscription.',
      videoUrl: 'https://www.youtube.com/watch?v=Nt77EkkagUM',
      operationType: "OTHER",
      method: "OTHER",
      difficulty: "MEDIUM",
      author: 'GIBLIB Conference Faculty',
      clinic: 'GIBLIB - Premium Medical Education Platform',
      durationMinutes: 11,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&q=80',
    },
    {
      title: 'Common Disorders of the Esophagus and Stomach: Medical Conference',
      description: 'Medical conference preview on common disorders of the esophagus and stomach including diagnosis and management. Professional medical education from GIBLIB platform. Full conference video available with subscription at watch.giblib.com.',
      videoUrl: 'https://www.youtube.com/watch?v=P68fpLGfvys',
      operationType: "OTHER",
      method: "OTHER",
      difficulty: "MEDIUM",
      author: 'GIBLIB Conference Faculty',
    ...
    {
      title: 'Eye, Ear, Nose, and Throat: ENT Medical Conference',
      description: 'Comprehensive ENT conference covering eye, ear, nose, and throat conditions. Educational medical conference preview from GIBLIB streaming service. Complete conference accessible on watch.giblib.com with healthcare professional subscription.',
      videoUrl: 'https://www.youtube.com/watch?v=GAhUEk3shT8',
      operationType: "OTHER",
      method: "OTHER",
      difficulty: "MEDIUM",
      author: 'GIBLIB Conference Faculty',
    ...
    {
      title: 'Bariatric Surgery: Update on Current Practice',
      description: 'Medical conference update on current bariatric surgery practice including latest techniques and outcomes. Educational preview from GIBLIB medical education platform. Full conference video available on watch.giblib.com with subscription.',
      videoUrl: 'https://www.youtube.com/watch?v=BCSR7LHNv04',
      operationType: "GASTRECTOMY",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'GIBLIB Conference Faculty',
    ...
    {
      title: 'Hypertension: Diagnosis and Management - Medical Conference',
      description: 'Medical conference on hypertension diagnosis and management covering evidence-based approaches. Professional medical education from GIBLIB streaming platform. Complete conference accessible on watch.giblib.com for healthcare professionals.',
      videoUrl: 'https://www.youtube.com/watch?v=n_awQAMzKUU',
      operationType: "OTHER",
      method: "OTHER",
      difficulty: "MEDIUM",
      author: 'GIBLIB Conference Faculty',
    ...
    {
      title: 'Endoscopic Weight Loss Through the Mouth Techniques',
      description: 'Medical conference on endoscopic weight loss techniques performed through the mouth including latest innovations. Educational medical conference from GIBLIB platform. Full conference video available with subscription at watch.giblib.com.',
      videoUrl: 'https://www.youtube.com/watch?v=uZs7fJy0mAA',
      operationType: "OTHER",
      method: "ENDOSCOPIC",
      difficulty: "HIGH",
      author: 'GIBLIB Conference Faculty',
    ...
    // GENERAL BEST IN SURGERY VIDEOS (18 предыдущих видео)
    {
      ...
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_1',
      operationType: "COLORECTAL",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопическая пангистерэктомия с аортокавальной лимфаденэктомией',
      description: 'Laparoscopic panhysterectomy with aortocaval lymphadenectomy and marginal rectal resection for adenocarcinoma of invasive endometriosis. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_2',
      operationType: "GYNECOLOGIC",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
      clinic: 'Best in Surgery',
    ...
    {
      title: 'Рефундопликация по поводу ГПОД. Мастер-класс компании Карл Шторц',
      description: 'Refundoplication for hiatal hernia. Master class by Karl Storz company. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_3',
      operationType: "HERNIA_REPAIR",
      method: "LAPAROSCOPIC",
      difficulty: "MEDIUM",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопическая спленэктомия с аутотрансплантацией селезёночной ткани',
      description: 'Laparoscopic splenectomy with autotransplantation of splenic tissue into greater omentum. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_4',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопическая органосохраняющая резекция надпочечника при альдостероме',
      description: 'Laparoscopic organ-sparing resection of adrenal gland for aldosteroma. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_5',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Рак почки. Лапароскопическая резекция почки при раке',
      description: 'Kidney cancer. Laparoscopic kidney resection for cancer. Jewelry preparation by Professor Puchkov. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_6',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопический шейвинг мочевого пузыря при эндометриозе',
      description: 'Laparoscopic bladder shaving for endometriosis. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_7',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопическая миомэктомия с временной окклюзией маточных артерий',
      description: 'Laparoscopic myomectomy with temporary occlusion of uterine arteries. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_8',
      operationType: "GYNECOLOGIC",
      method: "LAPAROSCOPIC",
      difficulty: "MEDIUM",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопическая резекция толстой кишки при эндометриозе',
      description: 'Laparoscopic colon resection for endometriosis. Advanced laparoscopic colorectal surgery. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_9',
      operationType: "COLORECTAL",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопическая резекция желудка при раке',
      description: 'Laparoscopic gastric resection for cancer. Advanced laparoscopic gastric surgery. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_10',
      operationType: "GASTRECTOMY",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопическая нефрэктомия при раке почки',
      description: 'Laparoscopic nephrectomy for kidney cancer. Advanced laparoscopic urological oncology. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_11',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопическая паховая герниопластика по методике TEP',
      description: 'Laparoscopic inguinal hernioplasty using TEP technique. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_12',
      operationType: "HERNIA_REPAIR",
      method: "LAPAROSCOPIC",
      difficulty: "MEDIUM",
      author: 'Пучков К.В.',
    ...
    },
    {
      ...
      description: 'Laparoscopic cholecystectomy for acute cholecystitis. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_13',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "MEDIUM",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопическая резекция поджелудочной железы при раке',
      description: 'Laparoscopic pancreatic resection for cancer. Advanced laparoscopic pancreatic surgery. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_14',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопическая овариэктомия при раке яичника',
      description: 'Laparoscopic ovariectomy for ovarian cancer. Advanced laparoscopic gynecologic oncology. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_15',
      operationType: "GYNECOLOGIC",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопическая гастрошунтирование при морбидном ожирении',
      description: 'Laparoscopic gastric bypass for morbid obesity. Bariatric surgery. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_16',
      operationType: "GASTRECTOMY",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопическая резекция прямой кишки при раке',
      description: 'Laparoscopic rectal resection for cancer. Advanced laparoscopic colorectal oncology. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_17',
      operationType: "COLORECTAL",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
    ...
    {
      title: 'Лапароскопическая простатэктомия при раке предстательной железы',
      description: 'Laparoscopic prostatectomy for prostate cancer. Advanced laparoscopic urological oncology. Best in Surgery educational content.',
      videoUrl: 'https://www.youtube.com/watch?v=best_in_surgery_18',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'Пучков К.В.',
    ...
    // Note: Профессиональные онлайн-семинары от образовательных медицинских центров
    {
      ...
      description: 'Видеозапись онлайн-семинара для врачей "Рак пищевода". Профессор Сергей Юрьевич Дворецкий (д.м.н., доцент, профессор кафедры онкологии Факультета последипломного обучения ПСТГМУ им. акад. И.П. Павлова) подробно рассказывает о раке пищевода (РП) — высокозлокачественном, трудно поддающемся лечению заболевании, которое занимает 8-е место в структуре онкологических заболеваний. Семинар охватывает этиологию, патогенез, клиническую картину, современные методы диагностики и комплексного лечения рака пищевода. Образовательный семинар от ОБРФМ.РУ - Образовательного центра «Интернет Лид» (Знания для врачей).',
    ...
    // NEW WEBSURG VIDEOS - FOCUS ON GENERAL SURGERY COLLECTION (10 новых видео)
    {
      title: 'Aorto-mesenteric compass syndrome (Wilkie\'s syndrome): Hypertrophic duodenojejunostomy',
      description: 'Surgical treatment of aorto-mesenteric compass syndrome (Wilkie\'s syndrome) using hypertrophic duodenojejunostomy technique. Rare vascular compression syndrome. WebSurg professional content from Focus on General Surgery collection.',
      videoUrl: 'https://websurg.com/ru/educational-content/monthly-focus/fc01en125',
      operationType: "GASTRECTOMY",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'SC Barone, M Di Corpo',
      clinic: 'IRCAD WebSurg',
      durationMinutes: 5,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579154204601-01588f351e67?w=800&q=80',
    },
    {
      title: 'Laparoscopic marginal resection of the inferior vena cava (IVC) with autologous vein patch',
      description: 'Advanced laparoscopic technique for marginal resection of inferior vena cava (IVC) tumor with autologous vein patch reconstruction. Complex vascular surgery. WebSurg professional content from Focus on General Surgery collection.',
      videoUrl: 'https://websurg.com/ru/educational-content/monthly-focus/fc01en125',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'P Agami, V Axdurlayman, M Bayekhanov, A Kharazov, R Izrailov',
      clinic: 'IRCAD WebSurg',
      durationMinutes: 19,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&q=80',
    },
    {
      title: 'Video-endoscopic inguinal lymphadenectomy for Merkel cell carcinoma\'s nodal metastasis',
      description: 'Video-endoscopic inguinal lymphadenectomy technique for Merkel cell carcinoma nodal metastasis. Minimally invasive oncological lymph node dissection. WebSurg professional content from Focus on General Surgery collection.',
      videoUrl: 'https://websurg.com/ru/educational-content/monthly-focus/fc01en125',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'CS Rodrigues, C Ribeiro, J Abreu de Sousa',
      clinic: 'IRCAD WebSurg',
      durationMinutes: 15,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&q=80',
    },
    {
      title: 'Post-esophagectomy hiatal hernia laparoscopic repair',
      description: 'Laparoscopic repair of post-esophagectomy hiatal hernia. Management of surgical complication after esophageal resection. WebSurg professional content from Focus on General Surgery collection.',
      videoUrl: 'https://websurg.com/ru/educational-content/monthly-focus/fc01en125',
      operationType: "ESOPHAGEAL_SURGERY",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'I Bertão Caldeo, D Gaspar, AM Marques, A Gomes, A Tojal, C Marques, J Pereira',
      clinic: 'IRCAD WebSurg',
      durationMinutes: 9,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579165466741-7f35e4755660?w=800&q=80',
    },
    {
      title: 'Laparoscopic subtotal anterograde cholecystectomy for the management of emphysematous cholecystitis',
      description: 'Laparoscopic subtotal anterograde cholecystectomy technique for management of emphysematous cholecystitis. Complex emergency gallbladder surgery. WebSurg professional content from Focus on General Surgery collection.',
      videoUrl: 'https://websurg.com/ru/educational-content/monthly-focus/fc01en125',
      operationType: "HEPATOBILIARY",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'E Bertano, A Langellola, P Riva, M Vila, A Forgione, D Mutter, J Marescaux',
      clinic: 'IRCAD WebSurg',
      durationMinutes: 9,
      thumbnailUrl: 'https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&q=80',
    },
    {
      title: 'Linear-stapled esophagojejunostomy in laparoscopic total gastrectomy',
      description: 'Linear-stapled esophagojejunostomy reconstruction technique in laparoscopic total gastrectomy for gastric cancer. Advanced anastomosis technique. WebSurg professional content from Focus on General Surgery collection.',
      videoUrl: 'https://websurg.com/ru/educational-content/monthly-focus/fc01en125',
      operationType: "GASTRECTOMY",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'D Venturini Dionisio, C Marques, A Pupo, H Pinto Marques',
      clinic: 'IRCAD WebSurg',
      durationMinutes: 10,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579154204601-01588f351e67?w=800&q=80',
    },
    {
      title: 'Linear-stapled esophagojejunostomy in laparoscopic total gastrectomy using indocyanine green (ICG) for lymph node mapping',
      description: 'Linear-stapled esophagojejunostomy technique in laparoscopic total gastrectomy using indocyanine green (ICG) fluorescence for lymph node mapping. Advanced image-guided surgery. WebSurg professional content from Focus on General Surgery collection.',
      videoUrl: 'https://websurg.com/ru/educational-content/monthly-focus/fc01en125',
      operationType: "GASTRECTOMY",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'F Dias Mendes, P Carvalho Martins, J Abreu de Sousa',
      clinic: 'IRCAD WebSurg',
      durationMinutes: 10,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579154204601-01588f351e67?w=800&q=80',
    },
    {
      title: 'Laparoscopic treatment of median arcuate ligament syndrome (MALS): a case report',
      description: 'Laparoscopic resection technique for huge intrathoracic median arcuate ligament syndrome (MALS). Rare vascular compression syndrome case. WebSurg professional content from Focus on General Surgery collection.',
      videoUrl: 'https://websurg.com/ru/educational-content/monthly-focus/fc01en125',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'A Fernandez-Candela, P Bretcha-Boix, P Muñoz, A Paz, J Farre-Alegre',
      clinic: 'IRCAD WebSurg',
      durationMinutes: 7,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&q=80',
    },
    {
      title: 'Principles of safe laparoscopic approach for "median arcuate ligament syndrome" (MALS)',
      description: 'Principles and safe approach to laparoscopic treatment of median arcuate ligament syndrome (MALS). Systematic surgical technique. WebSurg professional content from Focus on General Surgery collection.',
      videoUrl: 'https://websurg.com/ru/educational-content/monthly-focus/fc01en125',
      operationType: "OTHER",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'M Mares, A Ghanim, I Al-Slaibi',
      clinic: 'IRCAD WebSurg',
      durationMinutes: 12,
      thumbnailUrl: 'https://images.unsplash.com/photo-1579684385127-1ef15d508118?w=800&q=80',
    },
    {
      title: 'Laparoscopic management of an appendiculocutaneous fistula - a video vignette',
      description: 'Laparoscopic management technique for appendiculocutaneous fistula. Rare surgical complication treatment. WebSurg professional content from Focus on General Surgery collection.',
      videoUrl: 'https://websurg.com/ru/educational-content/monthly-focus/fc01en125',
      operationType: "COLORECTAL_SURGERY",
      method: "LAPAROSCOPIC",
      difficulty: "HIGH",
      author: 'E Mohamed, Y Haddad, E Amis, R Singh, J Lund',
      clinic: 'IRCAD WebSurg',
      durationMinutes: 6,
      thumbnailUrl: 'https://images.unsplash.com/photo-1530026405186-ed1f139313f8?w=800&q=80',
    },
  ...
  console.log('✅ Видео созданы (353 видео: 229 WebSurg (219 базовых + 10 Focus on General Surgery) + 24 Best in Surgery (18 общих + 6 по раку кишечника) + 12 SAGES + 12 MedTube + 12 GIBLIB + 12 World Laparoscopy + 12 iLappSurgery + 8 Higher School of Oncology CT + 30 других + 1 ОБРФМ.РУ + 1 4SURGEONSCLUB)');
